<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="StudentArchive1.SignUp" %>
...
">
                 <div class="card-body">
                     ...
                     <div class="row">
                          <div class="col">
                               <center>
                                 <h4 id="hsu" runat="server"> User Sign Up</h4>
                               </center>
                          </div>
                    </div>
                    <div class="row">
                           ...
                           <br />
                            <div class="form-group">
                                   ...
                                   <%// <input class="btn btn-primary btn-lg" id="Button1" type="button"  value="Sign Up" />%> 
                                        <asp:Button class="btn btn-primary btn-lg" ID="btnsig" runat="server" Text="Sign Up" OnClick="btnsig_Click" />
