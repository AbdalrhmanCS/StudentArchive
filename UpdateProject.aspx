<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="UpdateProject.aspx.cs" Inherits="StudentArchive1.UpdateProject" %>
...
" >
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <center>
                                <img  width="100" src="imgs/scheme.png" /><br /><br />
                            </center>
                        </div>
                    </div>
                    <div class="row">
                         <div class="col">
                              <center>
                                <h4 id="hupd" runat="server">Update Project</h4>
                              </center>
                         </div>
                   </div>
                   <div class="row">
                   ...
                   <div class="row">
                        <div class="col-md-6">
                          ...
                          <label id="lblptit" runat="server">Project Title</label>
                           <div class="form-group">
                        ...
                        <div class="col-md-6">
                          <label id="lblsup">Supervisor Name</label>
                           <div class="form-group">
                              
                                    <asp:TextBox class="form-control text-bg-secondary" ID="txtsname" runat="server" placeholder="Supervisor Name" ></asp:TextBox>
                               <br />
                           </div>                              
                        </div>
                      ...
                      <div class="row">
                            <div class="col-md-6">
                               ...
                               <label id="lblsn1" runat="server">Student Name </label>
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <label id="lblsn2" runat="server">Student Name </label>
                                               <div class="form-group">
                      ...
                      <div class="row">
                            <div class="col-md-6">
                               ...
                               <label id="lblsn3" runat="server">Student Name </label>
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <label id="lblsn4" runat="server">Student Name (ان وجد)</label>
                                               <div class="form-group">
                          ...
                          <br />
                           <div class="form-group">
                                   ...
                                   <div class="d-grid gap-2">
                                    ...
                                    <asp:Button class="btn btn-warning btn-lg" ID="btnup" runat="server" Text="Update" OnClick="btnup_Click" />
